...
export default function ProjeDosyalari() {
    ...
    for (let i = 0; i < yeniDosyalar.length; i++) {
      ...
      try {
        ...
        await supabase.from('drive_dosyalar').insert({
          santiye_id: yuklenecekSantiye, sayfa_turu: 'proje', klasor_yolu: 'Genel',
  ...
  return (
    <div className="premium-page-proje">
      <style>{`
        .premium-page-proje {
      ...
      <div className="drv-header">
        <h2 className="drv-title">Proje & Yönetim Dosyaları</h2>
      </div>
      ...
      {(aktifSekme === 'tum' || seciliSantiyeKlasoru) && (
        <div>
              ...
              >
                {yukleniyor ? (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                    ...
                    <p style={{ margin: 0, fontSize: 14, fontWeight: 700, color: '#4f46e5' }}>Yükleniyor...</p>
                  </div>
                ) : (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
          ...
          <div 
            ...
            onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}
            style={{ background: surukleniyor ? '#eef2ff' : 'transparent', padding: surukleniyor ? 10 : 0 }}
          >
